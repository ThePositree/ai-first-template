...
Do not move an idea into backlog, a spec, or code without explicit owner
approval. When an idea becomes relevant to current work, remind the owner briefly
and ask before changing its lifecycle.
