...
Use priority headings for approved backlog items:
...
- add backlog entries only when the owner clearly approves future work;
- do not convert every idea or concern into backlog;
- ask a short clarifying question when approval is unclear.
